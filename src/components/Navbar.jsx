...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        const storedWishlist = JSON.parse(localStorage.getItem('addCart')) || [];
                ...
                pathname === '/' ? (
                    <div className="navbar bg-[#9538e2] p-6 text-white">
                        ...
                        <div className="navbar-end gap-2">
                            <button onClick={() => navigate('/dashboard')} className="border rounded-full p-2 bg-white text-black">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                                </svg> 
                                ({cartCount})
                            </button>
                            <button className="border bg-white text-black rounded-full p-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                    ...
                    <div className="navbar bg-base-100 p-6 text-gray-500">
                        <div className="navbar-start">
                            <div className="dropdown">
                                <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
                                    <svg
