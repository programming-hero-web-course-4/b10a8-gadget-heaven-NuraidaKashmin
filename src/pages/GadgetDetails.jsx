...
import { addToCart, getAllCartData } from "../utils";
                ...
                <div className="absolute top-2/3 left-1/2 transform -translate-x-1/2 grid grid-cols-2 gap-4 p-4 bg-base-100 rounded-3xl">
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-4 mt-4">
                            <NavLink onClick={() => handleCart(gadgets)} className={'btn rounded-full text-white bg-[#9538e2]'}>Add to cart</NavLink>
                            <NavLink disabled ={isFavorite} onClick={() => handleCart(gadgets)} className="btn border bg-white text-black rounded-full p-2">
